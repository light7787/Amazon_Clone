...
function Header() {
  ...
  return (
    <div className="header h-[60px] flex align-middle bg-[#131921] sticky top-0 z-100">
      <NavLink to="/">
        <img
          className="header__logo md:w-[150px] md:mt-0 md:h-[60px] md:mb-[18px] ml-[20px] mr-[20px] sm:w-[50px] sm:ml-[10px] sm:mr-[10px] sm:mt-[10px] mix-blend-difference"
      ...
      <div className="header__search flex-1 align-middle">
        <div className="search flex p-[20px]">
          ...
          />
          <SearchIcon className="header__searchIcon p-[5px] h-[22px] bg-[#cd9042]" onClick={GotoSearch} /> 
        </div>
      </div>
